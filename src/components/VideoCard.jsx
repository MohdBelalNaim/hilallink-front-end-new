...
<div className="feed-item">
    ...
    <div className="feed-item-title">
        <div className="feed-title-item">
            <div className="feed-user-info-wrapper">
                ...
                <div className="feed-user-info">
                    <div className='feed-user-name'><Link to="/user" style={{"textDecoration":"none","color":"black"}}><b>{props.title}</b></Link></div>
        ...
        <div className="feed-title-item">
            <div className='feed-edit-options'>
                <span className='feed-time'>42 min</span>
    ...
    <div className="feed-item-image">
        <video src={props.image} controls className='feed-post-image'></video>
    </div>
